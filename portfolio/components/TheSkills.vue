<template>
    <div>
        <h2 class="text-2xl uppercase font-bold tracking-wider text-center mb-5">Skills</h2>
        <div class="flex justify-center">
            <div class="mx-6">
                <ul class="space-y-8 text-center text-gray-50">
                    <li class="bg-blue-400 rounded px-5 py-2 transform transition duration-500 hover:-translate-y-1">HTML/CSS</li>
            ...
            <div class="w-2/5 max-w-xs my-auto">
                <img src="@/assets/Report.svg" alt="Sitting">
            </div>
        </div>
    </div>
</template>